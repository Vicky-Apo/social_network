...
"[project]/frontend/src/app/component/AuthContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const readStoredSession = ()=>{
    ...
    ;
    const rawLocal = undefined;
    const rawSession = undefined;
    const raw = undefined;
};
const useAuth = ()=>{
...
const AuthProvider = ({ children })=>{
    ...
    const login = (newToken, nextUser, remember = true)=>{
        setToken(newToken);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5c5a3fdf._.js.map