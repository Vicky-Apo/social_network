        ...
        <section className="space-y-5">
          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                <h1 className="text-xl font-semibold tracking-tight text-neutral-900">Followers</h1>
                <p className="text-sm text-neutral-600">
                  {isOwner ? "People following you." : "Followers list."}
                </p>
              </div>
              <button
                type="button"
                ...
                {followers.map((person) => (
                  ...
                  >
                    ...
                    {isOwner ? (
                      <button
                        type="button"
                        onClick={() => removeFollower(person.id)}
        ...
        <aside className="hidden lg:block">
          <div className="rounded-3xl border border-neutral-200 bg-white p-5 shadow-sm">
            ...
            <p className="mt-2 text-xs text-neutral-500">
              Removing a follower will revoke access to your private content.
            </p>
          </div>
        </aside>
      </main>
