      ...
      <div className="brand-gradient-soft rounded-[2rem] border brand-border p-8 shadow-[0_30px_60px_-40px_rgba(2,6,23,0.45)] md:p-12">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <Link
            ...
            className="brand-gradient group mt-8 inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-900/70 focus-visible:ring-offset-2"
          >
