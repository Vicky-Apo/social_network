...
type Repository interface {
	...
	GetPostReaction(ctx context.Context, postID, userID int64) (PostReaction, error)
	...
	GetCommentReaction(ctx context.Context, commentID, userID int64) (CommentReaction, error)
}
